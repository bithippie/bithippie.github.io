        ...
        <div className="flex flex-col space-y-4 my-8 ">
          <RevealOnScroll>
            <div className="flex flex-col my-4 text-center items-stretch lg:flex-row lg:space-x-8">
              <img src="/idea.png" className="rounded-xl m-auto max-w-96 lg:max-w-80" />
              <div className="flex flex-col space-y-8 text-center lg:text-left">
                <h2 className="text-3xl sm:text-4xl text-moss py-6">Rapid Product Development</h2>
                <p className="flex text-xl flex-grow ">
                  Our unique blend of deep techincal experience, stategic partnerships, maticulously chosen tooling,
                  and AI companions, means our customers see first delivery of an idea in as little as 1&nbsp;month!
                  <br/><br/>
                  Timing is critical: Don&apos;t waste time trying to guess what the market wants - build,
          ...
          <RevealOnScroll>
            <div className="flex flex-col my-4 text-center items-stretch lg:flex-row lg:space-x-8">
              <img src="/science.png" className="rounded-xl m-auto max-w-96 lg:max-w-80" />
              <div className="flex flex-col space-y-8 text-center lg:text-left">
                <h2 className="text-3xl sm:text-4xl text-moss py-6">A Tech Backbone that Scales</h2>
                ...
                <div className="flex flex-wrap space-x-8">
                  <img src="/icons/aws.png" alt="AWS Icon" className="h-10 my-4" />
                  <img src="/icons/gcp.png" alt="GCP Icon" className="h-8 my-4" />
                  <img src="/icons/render.png" alt="Render.com Icon" className="h-8 my-4" />
                </div>
              </div>
            </div>
          </RevealOnScroll>
          <RevealOnScroll>
            <div className="flex flex-col my-4 text-center items-stretch lg:flex-row lg:space-x-8">
              <img src="/community.png" className="rounded-xl m-auto max-w-96 lg:max-w-80" />
              <div className="flex flex-col space-y-8 text-center lg:text-left">
                <h2 className="text-3xl sm:text-4xl text-moss py-6">On Demand Resource Pool</h2>
                <p className="flex text-xl flex-grow ">
          ...
          {/* <RevealOnScroll>
            ...
            <div className="flex flex-wrap justify-center space-x-4">
              <img src="/icons/gcp.png" alt="GCP Icon" className="h-8 my-4" />
              <img src="/icons/aws.png" alt="AWS Icon" className="h-8 my-4" />
              <img src="/icons/render.png" alt="Render.com Icon" className="h-8 my-4" />
            </div>
          </RevealOnScroll>
          <RevealOnScroll>
