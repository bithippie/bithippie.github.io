...
const outcomes = [
  {
    ...
    body: [
      ...
      "We build infrastructure and warehousing strategies that enable cross-functional analysis across computational and wet lab teams. Your scientists discover correlations earlier, refine predictions with real-world results, and make faster decisions\u2014while maintaining appropriate access controls.",
    ],
