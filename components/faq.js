    ...
    return (
        <section id="faq">
            ...
            <Accordion collapseAll theme={styles.root}>
                <Accordion.Panel>
                    <Accordion.Title theme={styles.title}>What will it cost?</Accordion.Title>
                ...
                <Accordion.Panel>
                    <Accordion.Title theme={styles.title}>How is the work structured?</Accordion.Title>
                    <Accordion.Content theme={styles.content}>
                        <p className="my-4">
                ...
                <Accordion.Panel>
                    <Accordion.Title theme={styles.title}>How are payments structured?</Accordion.Title>
                    <Accordion.Content theme={styles.content}>
                        <p className="my-4">
                ...
                <Accordion.Panel>
                    <Accordion.Title theme={styles.title}>What if I'm not happy?</Accordion.Title>
                    <Accordion.Content theme={styles.content}>
                        <p className="my-4">
                        ...
                        <p className="my-4">
                            Fret not, if this is something you’re worried about, check out <a href="#testimonials" className="text-moss underline">Why people love working with BitHippie!</a>
                        </p>
                    </Accordion.Content>
                </Accordion.Panel>
            </Accordion>
