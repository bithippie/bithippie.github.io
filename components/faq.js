      ...
      <Accordion collapseAll theme={styles.root}>
        <Accordion.Panel>
          ...
          <Accordion.Content theme={styles.content}>
            <p className="my-4">
              We know teams come with many different kinds of constraints. We
              try to work within everyone’s scope and budget.
            </p>
            <p className="my-4">
            ...
            <p className="my-4">
              The listed price does not indicate the price of a contract,
              pricing is a function of scope and complexity. This minimum has
              been provided to serve as a safeguard in the event your budget
              constraints are less than our threshold.
            </p>
            <p className="my-4">
              Our typical small-to-medium projects range between $12,000 -
              $24,000 USD per month.
            </p>
            <p className="my-4">
              We do offer discounted rates for engagements that are for 3 or
        ...
        <Accordion.Panel>
          ...
          <Accordion.Content theme={styles.content}>
            <p className="my-4">
              Our Sustainable Engineering model is designed to give you access
              to high quality Software, Data, and Cloud Engineers and
              Architects. Allowing you to keep your headcount and operating
              expenses low.
            </p>
            <p className="my-4">
            ...
            <p className="my-4">
              At the beginning of each Milestone all key stakeholders align on
              the main objectives.
            </p>
            <p className="my-4">
              The sprints serve as checkpoints within the Milestone to
              demonstrate progress, and provides an opportunity to realign in
              the event the circumstances change.
            </p>
            <p className="my-4">
        ...
        <Accordion.Panel>
          ...
          <Accordion.Content theme={styles.content}>
            ...
            <p className="my-4">
              ...
              we’ve completed the 1st sprint. 1/3 is due after we’ve completed
              the 2nd sprint.
            </p>
            <p className="my-4">
        ...
        <Accordion.Panel>
          ...
          <Accordion.Content theme={styles.content}>
            ...
            <p className="my-4">
              ...
              invoiced for work delivered and any off-boarding work you
