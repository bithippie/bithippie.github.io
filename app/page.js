              ...
              <Reveal>
                <div className="max-w-96">
                  ...
                  <p className="text-justify">
                    ...
                    <br />
                    <br />
                    Timing is critical: Don’t guess what the market wants -
              ...
              <Reveal>
                <div className="max-w-96">
                  ...
                  <p className="text-justify">
                    ...
                    today with a growth plan for how to get where you’re going.
                  </p>
                </div>
              </Reveal>
              <Reveal>
                <div className="max-w-96">
                  ...
                  <p className="text-justify">
                    Why pay for what you don’t need? Our team of Software, Data,
                    and Cloud Engineers are available when you need for as long
                    as you need, keeping your operating expenses as low as
                    possible.
                  </p>
                </div>
              </Reveal>
            ...
            <div className="flex flex-col lg:flex-row">
              <div className="flex flex-col grow w-full">
                ...
                <p className="text-xl mb-8">
                  We love speaking with entrepreneurs, founders, and good humans
                  who strive to leave the world better than they found it.
                </p>
                <p className="text-xl mb-8">
                  If you’re ready to take action then do schedule a time to
                  speak with us.
                </p>
                <p className="text-xl">
                  In as little as 1 Month you and your customers will see the
                  manifestation of your idea. You’ll collect valuable data from
                  your users, and you’ll move forward with an informed opinion
        ...
        <section id="about" className="bg-white">
          <div className="container grid md:grid-cols-12 gap-8 p-8">
            ...
            <div className="col-span-12 md:col-span-5 text-justify flex flex-col items-center">
              ...
              <p className="mb-6">
                BitHippie was started by Founder and serial entrepreneur,
                Anthony Torres, when he came to the realization that mission and
                the people impacted matter much more than maximizing shareholder
                value.
              </p>
              <p className="mb-6">
                The best way to stay true to that ethos is by aligning his
                efforts with the kind of people who care about the Earth and its
                inhabitants.
              </p>
              <p className="mb-6">
                Rather than do this work alone, Anthony combined his passions
                for making things, personal development, and service into a
                one-of-a-kind community, a force for good.
              </p>
              <p className="mb-6">
                Together he, and the friends made along the way, work together
                to make real change in the world, hold one another accountable,
                improve and maintain our health, and constantly remind one
                another that “together we go far.”
              </p>
              <p className="mb-6">
                If you would like to learn more about the community, please
                reach out on LinkedIn and we can see if you’d be a good fit.
              </p>
